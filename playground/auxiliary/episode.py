    ...
    jobs_csv, algorithm, event_file):
        ...
        if self.method == 1:
            ...
            if os.path.exists(model_path):
                ...
                self.agent = DQLAgent(state_features_num, actions_features_num, 0.7, jobs_num, layers, model)
                print("i loaded a pre-existing model")
            else:
                self.agent = DQLAgent(state_features_num, actions_features_num, 0.7, layers, jobs_num)
            ...
            [0.0, 0.0, 0.7412052888888888, 0.7318317333333334, 0.0, 0.0, 0.9, 0.35714285714285715, 0.016, 0.125, 0.1896409203070734, 0.0, 0.0657, 0.0, 0.0, 0.0641, 0.0],
            [0.0, 0.0, 0.03560407407407407, 0.03550648148148148, 0.9683300000000004, 0.9251822222222224, 0.06666666666666667, 0.8571428571428571, 0.016666666666666666, 0.125, 0.39229239591897064, 0.0, 0.0076, 0.0082, 0.0, 0.0, 0.0074],
            [0.2409044444444445, 0.22157, 0.16685066666666665, 0.17248080952380943, 0.23771934567901232, 0.2373433827160493, 0.23333333333333334, 1.0, 0.75, 0.125, 0.3204020590747798, 0.0063, 0.044, 0.0792, 0.0, 0.0, 0.0],
            [0.9543233333333334, 0.9564566666666673, 0.9128883547008547, 0.9295299999999995, 0.24331587654320988, 0.23342280246913585, 0.06666666666666667, 0.7428571428571429, 0.75, 0.125, 0.23459474688057027, 0.0075, 0.1782, 0.0779, 1.3847, 1.0404, 0.0],
            [0.7844454814814812, 0.7936771111111114, 0.76591426984127, 0.7669897460317456, 0.06570540740740743, 0.062449000000000025, 0.5, 1.0, 1.0, 0.125, 0.3232618251527046, 0.0428, 0.1955, 0.0273, 0.2017, 0.0, 0.0],
            [0.9193608888888892, 0.9459131851851854, 0.9402867555555555, 0.908723955555556, 0.8844939247311832, 0.9113925268817208, 0.5, 0.35714285714285715, 0.5166666666666667, 0.125, 0.21619090463912521, 0.0509, 0.0842, 0.2014, 0.6125, 0.2259, 0.5851],
