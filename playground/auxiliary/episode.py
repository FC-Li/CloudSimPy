    ...
    jobs_csv, algorithm, event_file):
        ...
        if self.method == 1:
            ...
            if os.path.exists(model_path):
                ...
                self.agent = DQLAgent(6, 13, 0.7, jobs_num, model)
                print("i loaded a pre-existing model")
            else:
                self.agent = DQLAgent(6, 13, 0.7, jobs_num)
            reward_giver = RewardGiver(cluster)
            self.scheduler = DQLScheduler(self.agent, cluster, reward_giver)
                    # list_states = []
            self.agent.test_act([[0.0, 0.0, -0.000000000000213, 0.000000000003647367308464056, 0.0026246811594202828, 0.00041104347826087],
            [0.4, 0.2, -0.000000000000213, 0.000000000003647367308464056, 0.0026246811594202828, 0.00041104347826087],
            [0.8656290000000003, 0.6669128333333329, 0.751532266666666, 0.3508053333333343, 0.2606587083333316, 0.1009027777777783],
            [0.3656290000000003, 0.1669128333333329, 0.851532266666666, 0.5508053333333343, 0.2606587083333316, 0.1009027777777783],
            [0.3656290000000003, 0.1669128333333329, 0.951532266666666, 0.6508053333333343, 0.7606587083333316, 0.5009027777777783],
            [0.6656290000000003, 0.2669128333333329, 0.751532266666666, 0.3508053333333343, 0.8606587083333316, 0.32809027777777783],
            [0.9656290000000003, 0.4669128333333329, 0.951532266666666, 0.3508053333333343, 0.9606587083333316, 0.32809027777777783]])
