...
from playground.utils.tools import average_completion, average_slowdown
...
for itr in range(n_iter):
	...
	for i in range(12):
		...
		algorithm = RLAlgorithm(agent, reward_giver, features_extract_func=features_extract_func, features_normalize_func=features_normalize_func)
		episode = Episode(machine_configs, jobs_configs, algorithm, None)
